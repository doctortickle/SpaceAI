...
public strictfp enum UnitType {
    ...
    FIGHTER (   new WeaponType[] {WeaponType.SMALL_LASER},  // arsenal
                ...
                0,      // harvestingRadius
                0,      // harvestingRate
                new Image("images/FIGHTER.png", 5*GameConstants.COORDINATE_TO_PIXEL*2, 5*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    SIEGE(   new WeaponType[] {WeaponType.SMALL_LASER, WeaponType.PLANET_BOMBARDMENT},  // arsenal
                ...
                0,      // harvestingRadius
                0,      // harvestingRate 
                new Image("images/SIEGE.png", 8*GameConstants.COORDINATE_TO_PIXEL*2, 8*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    DESTROYER(  new WeaponType[] {WeaponType.SMALL_LASER, WeaponType.LARGE_LASER, WeaponType.SMALL_BOMB, WeaponType.MINE},  // arsenal
                ...
                0,      // harvestingRadius
                0,      // harvestingRate
                new Image("images/DESTROYER.png", 10*GameConstants.COORDINATE_TO_PIXEL*2, 10*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    CAPITAL(    new WeaponType[] {WeaponType.SMALL_LASER, WeaponType.LARGE_LASER, WeaponType.SMALL_BOMB, WeaponType.LARGE_BOMB, WeaponType.MINE, WeaponType.PLANET_BOMBARDMENT},  // arsenal
                ...
                0,      // harvestingRadius
                0,      // harvestingRate
                new Image("images/CAPITAL.png", 20*GameConstants.COORDINATE_TO_PIXEL*2, 20*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    HARVESTER(  null,   // arsenal
                ...
                20,      // harvestingRate
                new Image("images/HARVESTER.png", 5*GameConstants.COORDINATE_TO_PIXEL*2, 5*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    REFUELER(   null,   // arsenal
                ...
                0,      // harvestingRadius
                0,      // harvestingRate
                new Image("images/REFUELER.png", 5*GameConstants.COORDINATE_TO_PIXEL*2, 5*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    BUILDER(    null,   // arsenal
                ...
                0,      // harvestingRadius
                0,      // harvestingRate
                new Image("images/BUILDER.png", 5*GameConstants.COORDINATE_TO_PIXEL*2, 5*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    HOME_STATION(   null,   // spawnLocations
                    ...
                    0,      // harvestingRadius    
                    10,     // harvestingRate
                    new Image("images/HOME_STATION.png", 10*GameConstants.COORDINATE_TO_PIXEL*2, 10*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    SMALL_DOCK(     new EnvironmentType[] {EnvironmentType.SMALL_PLANET, EnvironmentType.LARGE_PLANET},   // spawnLocations
                    ...
                    0,      // harvestingRadius
                    0,      // harvestingRate
                    new Image("images/TestImage.png", 5*GameConstants.COORDINATE_TO_PIXEL*2, 5*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    LARGE_DOCK(     new EnvironmentType[] {EnvironmentType.SMALL_PLANET, EnvironmentType.LARGE_PLANET},   // spawnLocations
                    ...
                    0,      // harvestingRadius
                    0,      // harvestingRate
                    new Image("images/TestImage.png", 8*GameConstants.COORDINATE_TO_PIXEL*2, 8*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
    ...
    CAPITAL_DOCK(   new EnvironmentType[] {EnvironmentType.LARGE_PLANET},   // spawnLocations
                    ...
                    0,      // harvestingRadius
                    0,      // harvestingRate
                    new Image("images/TestImage.png", 15*GameConstants.COORDINATE_TO_PIXEL*2, 15*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)  // spriteImage
    ),
    /**
