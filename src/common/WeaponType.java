...
public strictfp enum WeaponType {
    ...
    /*              launchSpd   weaponRad   exRad   detRad  dam strDam  relTime   */
                    new Image("images/SMALL_LASER.png", 2*GameConstants.COORDINATE_TO_PIXEL*2, 2*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)),
    /**
    ...
    /*              launchSpd   weaponRad   exRad   detRad  dam strDam  relTime   */
                    new Image("images/TestImage.png", 4*GameConstants.COORDINATE_TO_PIXEL*2, 4*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)),
    /**
    ...
    /*              launchSpd   weaponRad   exRad   detRad  dam strDam  relTime   */
                    new Image("images/SMALL_BOMB.png", 4*GameConstants.COORDINATE_TO_PIXEL*2, 4*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)),
    /**
    ...
    /*              launchSpd   weaponRad   exRad   detRad  dam strDam  relTime   */
                    new Image("images/LARGE_BOMB.png", 7*GameConstants.COORDINATE_TO_PIXEL*2, 7*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true)),
    /**
    ...
    /*              launchSpd   weaponRad   exRad   detRad  dam strDam  relTime   */
                    new Image("images/TestImage.png", 7*GameConstants.COORDINATE_TO_PIXEL*2, 7*GameConstants.COORDINATE_TO_PIXEL*2, true, false, true));
